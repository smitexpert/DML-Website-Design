(function($){
    $.fn.smNavMenu = function(){
        ...
        $(".sm-responsive-nav ul").prepend('<li class="toggle-menu"><a href="#">Menu</a><ul class="left-collaps">'+rightMenu+'</ul><button id="sm-nav-collaps"><i class="fas fa-bars"></i></button></li>');
